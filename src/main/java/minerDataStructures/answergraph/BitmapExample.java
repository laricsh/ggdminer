...
public class BitmapExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        EWAHCompressedBitmap ewahBitmap_1 =  EWAHCompressedBitmap.bitmapOf(1,2,3,4);
        EWAHCompressedBitmap ewahBitmap_2 =  EWAHCompressedBitmap.bitmapOf(0,3,4,5);
        System.out.println("bit map example::" + ewahBitmap_1);
        System.out.println("bit map example 2::" + ewahBitmap_2);
        ewahBitmap_1.toList();
        System.out.println(ewahBitmap_1.toList());
        //ewahBitmap_1.addWord(5);
        //ewahBitmap_1.addLiteralWord(6);
        ewahBitmap_1.set(6);
        ewahBitmap_2.set(6);
        EWAHCompressedBitmap andbitmap_x = ewahBitmap_1.and(ewahBitmap_2);
        System.out.println("bit map example::" + ewahBitmap_1);
        System.out.println("bit map example 2::" + ewahBitmap_2);
        System.out.println("and bit map x::" + andbitmap_x);
        ...
        ewahBitmap1.serialize(new

                DataOutputStream(bos));
        EWAHCompressedBitmap ewahBitmap1new = new EWAHCompressedBitmap();
        byte[] bout = bos.toByteArray();
        ewahBitmap1new.deserialize(new

                DataInputStream(new ByteArrayInputStream(bout)));
        System.out.println("bitmap 1 (recovered) : " + ewahBitmap1new);
        if (!ewahBitmap1.equals(ewahBitmap1new)) throw new

                RuntimeException("Will not happen");
        ...
        if (!rmap.equals(ewahBitmap1)) throw new
