...
public class Variable 
{
	...
	public HashSet<Integer> getLabelsDistanceConstrainedWith()
	{
		if(labelDistanceConstrainedWith==null)
		{
			...
			Vector<Integer> temp;
			try{
				temp = Searcher.neighborLabels.get(this.getLabel());
			}catch (Exception e){
				temp = GGDSearcher.neighborLabels.get(this.getLabel());
			}
	...
	public HashSet<Integer> getLabelsDistanceConstrainedBy()
	{
		if(labelDistanceConstrainedBy==null)
		{
			...
			Vector<Integer> temp;
			try{
				temp = Searcher.revNeighborLabels.get(this.getLabel());
			}catch (Exception e){
				temp = GGDSearcher.revNeighborLabels.get(this.getLabel());
			}
